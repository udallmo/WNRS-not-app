export const L1_QUESTIONS: string[] = [
  ...
  "WRITE A MESSAGE TO EACH OTHER AND GIVE IT TO EACH OTHER. OPEN IT ONCE YOU HAVE LEFT",
  '"THINK OF YOUR FAVOURITE CHILDHOOD TV SHOW OF ALL TIME, ON THE COUNT OF THREE SAY IT OUTLOUD (BOTH PLAYERS)"',
  "TAKE A SELFIE TOGETHER",
  "STARING CONTEST. FIRST-PERSON TO BLINK MUST REVEAL A PERSONAL PROBLEM AND ASK THE OTHER FOR ADVICE ON HOW THEY MIGHT HANDLE IT.",
  "CREATE YOUR OWN QUESTION. ANYTHING. MAKE IT COUNT.",
  "TELL THE OTHER PERSON TO CLOSE THEIR EYES AND TO KEEP THEM CLOSED. (WAIT 10 SECONDS. DESCRIBE TO THEM IN DETAIL YOUR FAVOURITE MEMORY OF THEM/ TWO OF YOU)",
  "TELL THE OTHER PERSON TO CLOSE THEIR EYES AND TO KEEP THEM CLOSED. (WAIT 15 SECONDS AND KISS THEM)",
  "PRESS SHUFFLE ON YOUR MUSIC LIBRARY. EXPLAIN THE FIRST SONG THAT COMES UP!",
  "LET GO OF YOUR ATTACHMENT TO THE OUTCOME wildcard character - BOTH PLAYERS SHARE SOMETHING YOU'RE MOST GRATEFUL FOR IN THIS CURRENT MOMENT.",
  "DRAW YOUR CURRENT FEELINGS THEN COMPARE.",
  "SHOW THE FIRST PHOTO IN YOUR CAMERA ROLL. EXPLAIN.",
  "THINK OF SOMETHING THAT YOU DISLIKE THAT MOST PEOPLE DON'T. ON THE COUNT OF 3 SAY IT OUTLOUD.",
  "SHARE A FAVOURITE MEMORY OF YOURS. COMPARE. (BOTH)",
  "SING YOUR FAVOURITE SONG LYRICS YOU CAN THINK OF OFF THE TOP OF YOUR HEAD. (BOTH)",
  "HOW CAN I ADD 1% MORE HAPPINESS IN YOUR LIFE?",
];
export const L2_QUESTIONS: string[] = [
  ...
  "What is your favourite part about yourself that isn't physical?",
  ...
  "Wha have you been taking for granted lately?",
  ...
  "When was the last's time you felt most yourself?",
  ...
  "Sing your favourite song lyrics off the top of your head. Both Players.",
  ...
  "Draw a picture together. (1 minute)",
  "What about me is hardest for you to understand?",
  "What is your favourite memory we share together? Both players. Compare.",
  ...
  "Write down the three most important things to you in a relationship (30 seconds). Compare.",
  "What's the most embarrassing thing that's ever happened to you?",
  "Admit something: what could you have done better in your previous relationship(s)?",
  "Admit a dating pet peeve (30 seconds). Compare.",
  "Finish the sentence: Dating is _____. (Both players)",
  ...
  '"Think of a movie that always makes you cry. On the count of 3, say your answers out loud. (Both players)."',
  ...
  "Do you need advice on anything in your life right now? Permission to vent. (Both players).",
  "Write down the three most important qualities in a best friend. (1 minute). Compare.",
  ...
  '"What leaves you the most energized, what leaves you the most drained?"',
];
export const L3_QUESTIONS: string[] = [
  ...
  '"Based off what you\'ve learned about me, do you have any netflix recommendations?"',
  ...
  "What do you admire most about me?",
  "Write a motivational reminder to your partner. Fold and exchange. Open when needed. (Both players).",
